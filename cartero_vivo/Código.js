function doPost(e) {
  ...
  if (action == "like") {
    ...
    // PORTON ANTIBOT: honeypot lleno, sin t0, o <3s = maquina.
    // Respuesta identica al exito real: rechazo invisible.
    var hpWeb = e.parameter.website || "";
    var t0Bot = parseInt(e.parameter.t0 || "0", 10);
