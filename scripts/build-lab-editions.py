...
/* =========================================================================
   ...
   CERO FILTROS DESTRUCTIVOS. CERO MIX-BLEND. CALIDAD ORIGINAL.
   ========================================================================= */
...
.btn-dark {{
  height: 46px; border-radius: 12px; display: flex; align-items: center; justify-content: center; gap: 6px;
  text-decoration: none; cursor: pointer; 
  background: #1A1A1A; /* Negro tinta elegante para Buscalibre y Crystal */
...
/* BUSCALIBRE: Intacto, naranja original vivo sobre fondo negro */
...
/* PENGUIN: Magia de camuflaje. El botón asume el gris oscuro del logo (#222222) */
.btn-penguin-icon {{
  background: #222222 !important; /* Mismo color de tu imagen */
  border: 1px solid #222222 !important;
}}
.btn-penguin-icon img {{ 
  height: 36px; 
  filter: none; /* CERO DISTORSIÓN */
  mix-blend-mode: normal; /* CERO EFECTOS RAROS */
  opacity: 1;
}}
