...
.btn-icon {{
  ...
  border: 1px solid rgba(26,26,26,0.08); /* Borde súper sutil */
...
/* Logo Triggui nativo (ya es negro) */
.btn-icon .btn-triggui-logo {{ height: 20px; opacity: 0.9; }} 

/* Instagram nativo trazos negros */
...
/* ════════════════════════════════════════════════════════════════
   🧙‍♂️ MAGIA BUSCALIBRE: MATEMÁTICA PURA
   Invertimos luminosidad (blanco->negro) y rotamos el color 180°
   (azul pitufo -> vuelve a naranja vibrante original).
   ════════════════════════════════════════════════════════════════ */
...
/* ════════════════════════════════════════════════════════════════
   🐧 MAGIA PENGUIN: EL EXORCISMO DEL FONDO NEGRO
   Invertimos colores (fondo negro->blanco). 
   Multiply hace que lo blanco se vuelva 100% transparente.
   ════════════════════════════════════════════════════════════════ */
...
/* === PANTALLA DE SILENCIO (Mística y oscura) === */
.silence-screen {{
