...
.reveal-card {{
  ...
  color: {esc(t_ink)};
  box-shadow: 0 60px 120px -30px rgba(0,0,0,0.85), 0 0 0 1px rgba(255,255,255,0.08);
  overflow: hidden;
  cursor: default;
...
/* ═══ TARJETA EDITORIAL (replica Apps Script) ═══ */
.card-logo-top {{
  padding: 18px 22px 14px;
  text-align: center;
}}
.card-logo-top img {{ height: 20px; width: auto; display: inline-block; opacity: 0.85; }}
...
.btn-fisico {{
  ...
  background: linear-gradient(135deg, #FF0055, #FF5E00, #FFD700);
  background-size: 200% 200%;
  animation: fire-move 8s ease infinite;
  box-shadow: 0 0 0 1px rgba(255,255,255,0.15), 0 6px 20px rgba(255,0,85,0.3);
  transition: transform 0.2s cubic-bezier(0.34,1.56,0.64,1);
  touch-action: manipulation;
}}
.btn-fisico:active {{ transform: scale(0.97); transition: transform 0.1s ease; }}
.btn-fisico:disabled {{ opacity: .6; cursor: default; transform: none; animation: none; }}
...
.reveal-overlay.silence .btn-back {{ display: none; }}
.silence-msg {{
  display: none;
  text-align: center;
  padding: 0 28px;
