...
(function(){try{if(new URLSearchParams(location.search).get('p')!=='1')return;var n=0,t=setInterval(function(){var v=document.getElementById('vinilo'),b=document.getElementById('vinNucleo');if(v&&v.classList.contains('on')&&b){clearInterval(t);setTimeout(function(){try{b.click();}catch(e){}},350);}else if(++n>60){clearInterval(t);}},150);}catch(e){}})();
</script>
</body>
</html>
"""
