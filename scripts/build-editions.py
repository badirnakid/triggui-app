...
.tg-marca-espera{display:none}
#tgModal.espera .tg-marca-espera{display:block;height:12px;width:auto;margin:14px auto 0;opacity:.75}
...
<div id="tgModal"><div class="tg-mglass"><div class="tg-memoji" id="tgMEmoji">&#10024;</div><img class="tg-marca-espera" src="https://raw.githubusercontent.com/badirnakid/triggui-app/main/public/trigguiletrasblanco2.png" alt=""><div class="tg-mtitle" id="tgMTitle"></div><div class="tg-mtext" id="tgMText"></div><div class="tg-mbtns"><button class="tg-btn tg-bp" id="tgMP"></button><button class="tg-btn tg-bs" id="tgMS"></button></div></div></div>
<div id="tgToast"></div>
